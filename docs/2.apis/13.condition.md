---
title: condition
description: Condition and branch generation (genIf, genElseIf, genElse, genTernary, genPrefixedBlock)
icon: i-lucide-square-function
---

This module provides APIs for generating `if` / `else if` / `else`, ternary expressions, and generic prefixed blocks (e.g. `while`).

<example module="condition"></example>
