---
description: Loop generation (genFor, genForOf, genForIn, genWhile, genDoWhile)
icon: i-lucide-square-function
---

This module provides APIs for generating `for`, `for...of`, `for...in`, `while`, and `do...while` loops.

<example module="loop"></example>
