---
description: Type alias and type expression generation (genTypeAlias, genTypeObject, genUnion, genIntersection, genMappedType, etc.)
icon: i-lucide-square-function
---

This module provides APIs for generating type aliases, object types, union/intersection types, mapped types, template literal types, and keyof/typeof/assertion/satisfies.

<example module="type-alias"></example>
