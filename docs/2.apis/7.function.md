---
description: Function and block generation (genFunction, genArrowFunction, genMethod, genBlock, genParam)
icon: i-lucide-square-function
---

This module provides APIs for generating function declarations, arrow functions, object methods, statement blocks, and parameter lists, with support for generics, async, generator, and JSDoc.
