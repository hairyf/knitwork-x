---
title: Function
description: Function-related APIs
---

函数相关工具（如 `genParam`、`genFunction`、`genArrowFunction` 等）。以下内容由 automd 从源码 JSDoc 与 `@example` 自动生成。

<!-- automd:jsdocs src=../../../src/typescript/function.ts group=Typescript headingLevel=2 -->
